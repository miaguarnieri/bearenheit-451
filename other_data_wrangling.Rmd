...
conflict_points_buffered <- st_buffer(conflict, dist = 5000)
...
#saving the file to intermediate data in the gdrive
 ...
 st_write(conflict, dsn = here(gdrive_data, "/IntermediateData/IntermediateData_Files/conflict_formatted/conflict_buffered", "conflict_buffered.shp"))
