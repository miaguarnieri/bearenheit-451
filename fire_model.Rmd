...
write.csv(fire_modeldf_16_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_16.csv"), row.names = FALSE)
...
write.csv(fire_modeldf_17_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_17.csv"), row.names = FALSE)
...
write.csv(fire_modeldf_18_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_18.csv"), row.names = FALSE)
```
...
write.csv(fire_modeldf_19_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_19.csv"), row.names = FALSE)
...
write.csv(fire_modeldf_20_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_20.csv"), row.names = FALSE)
...
write.csv(fire_modeldf_21_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_21.csv"), row.names = FALSE)
...
climdf16 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_16.csv"))

climdf17 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_17.csv"))

climdf18 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_18.csv"))

climdf19 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_19.csv"))

climdf20 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_20.csv"))

climdf21 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_modeldf_21.csv"))
...
write.csv(fire_model_data_allyears, file = here(gdrive_data, "/AnalysisData/model_df_climate/12_3_2022/fire_model_data_allyears.csv"), row.names = FALSE)
```
...
mod3fire <- rspf(conflict ~ dem + lc + forest_dist + popdens + rec_dist + streams_dist + 
    TRI + urban_dist + dist_fire_1yr + dist_fire_23yrs + dist_fire_45yrs, family = "binomial", m = 0, B = 1000, data = fire_model_data)
